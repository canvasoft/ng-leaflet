...
/*!***********************!*\
  !*** ../src/index.ts ***!
  \***********************/
/*! exports provided: NgLeafletModule, LeafletComponent, CenterDirective, SamplePipe, DefaultsService, LeafletCenter, LeafletTileLayer, LeafletMarkerClusterLayer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!******************************!*\
  !*** ../src/models/index.ts ***!
  \******************************/
/*! exports provided: LeafletCenter, LeafletTileLayer, LeafletMarkerClusterLayer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!************************************!*\
  !*** ../src/models/layer.model.ts ***!
  \************************************/
/*! exports provided: LeafletTileLayer, LeafletMarkerClusterLayer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var LeafletTileLayer = /** @class */ (function () {
    function LeafletTileLayer(id, name, type, url, isBaselayer, options) {
        ...
        switch (this.type) {
            case 'tile':
                this.layer = Object(leaflet__WEBPACK_IMPORTED_MODULE_1__["tileLayer"])(this.url, this.options);
                break;
            case 'wms':
            default:
                this.layer = leaflet__WEBPACK_IMPORTED_MODULE_1__["tileLayer"].wms(this.url, this.options);
                break;
        }
    }
...
var LeafletMarkerClusterLayer = /** @class */ (function () {
    function LeafletMarkerClusterLayer(id, name, markers, isBaselayer, options) {
        ...
        this.options = options;
        this.enabled = true;
        this.layer = Object(leaflet__WEBPACK_IMPORTED_MODULE_1__["markerClusterGroup"])({ chunkedLoading: true });
...
var routes = [_examples_home_home_route__WEBPACK_IMPORTED_MODULE_4__["HOME_ROUTE"], _examples_markercluster_markercluster_route__WEBPACK_IMPORTED_MODULE_3__["MARKERCLUSTER_ROUTE"]];
...
var HomeExampleComponent = /** @class */ (function () {
    function HomeExampleComponent() {
        ...
        this.layer1 = new _angular_ui_ng_leaflet__WEBPACK_IMPORTED_MODULE_2__["LeafletTileLayer"]('layer1', 'Openstreet Maps', 'tile', 'http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', false, {
            maxZoom: 18,
            attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
        });
        this.layer2 = new _angular_ui_ng_leaflet__WEBPACK_IMPORTED_MODULE_2__["LeafletTileLayer"]('layer2', 'Open Cycle Map', 'tile', 'http://{s}.tile.opencyclemap.org/cycle/{z}/{x}/{y}.png');
    }
...
/* harmony import */ var _angular_ui_ng_leaflet__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular-ui/ng-leaflet */ "../src/index.ts");
...
var MarkerClusterExampleComponent = /** @class */ (function () {
    function MarkerClusterExampleComponent() {
        this.center = new _angular_ui_ng_leaflet__WEBPACK_IMPORTED_MODULE_3__["LeafletCenter"](-37.89, 175.46, 12);
    }
    MarkerClusterExampleComponent.prototype.ngOnInit = function () {
        var markers = [];
        var baseLayer = new _angular_ui_ng_leaflet__WEBPACK_IMPORTED_MODULE_3__["LeafletTileLayer"]('layer1', 'Openstreet Maps', 'tile', 'http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', false, {
            maxZoom: 18,
            attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'
        });
        ...
        this.clusterLayer = new _angular_ui_ng_leaflet__WEBPACK_IMPORTED_MODULE_3__["LeafletMarkerClusterLayer"]('markercluster', 'Marker Cluster Layer', markers);
